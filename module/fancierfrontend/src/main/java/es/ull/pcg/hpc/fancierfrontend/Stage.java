...
public class Stage {
    ...
    public Stage() {
        this.stageName = "kernel_" + FancierManager.kernelCount;
    ...
    private String generateKernel() throws Exception {
        ...
        ArrayList<Parameter> parameters = FancierManager.getParametersForStage(stageName);
        int idx = 0;
    ...
    public void setInputs(Map<String, Object> inputElements) throws Exception {
        ...
        for (Map.Entry<String, Object> entry : inputElements.entrySet()) {
            ...
            FancierManager.addParameter(stageName, name, data, ParameterClass.INPUT, idx);
            idx += 1;
        }
    }
    ...
    public void setOutputs(Map<String, Object> outputElements) throws Exception {
        ...
        for (Map.Entry<String, Object> entry : outputElements.entrySet()) {
            String name = entry.getKey();
            Object data = entry.getValue();
            FancierManager.addParameter(stageName, name, data, ParameterClass.OUTPUT, idx);
            idx += 1;
        }
    }
    ...
    private void prepare() throws Exception {
        ...
        prepare(generateKernel(), stageName,
                FancierManager.getOrderedParamNamesForStage(stageName),
                FancierManager.getOrderedParamDataForStage(stageName),
                FancierManager.getOrderedParamTypes(stageName));
    }
    ...
    public void syncInputsToGPU() throws Exception {
        ArrayList<Parameter> params = FancierManager.getParametersForStage(stageName);
